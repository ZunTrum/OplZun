...
game:GetService("Workspace").LocalPlayer.CharacterTrait.Health = 0
    ...
    page9:Line()
        page9:Label("â”‡ QUAKE FARM TP METHOD â”‡")
    page9:Line()
...
game.Players.LocalPlayer.Character.Humanoid.Health = 0
 ...
 page2:Button("Teleport To Farm Spot (MAIN)",function()
    ...
    page2:Label("â”‡  AUTO FARM STATS â”‡ ")
...
v:Activate()
    ...
    page2:Label("â”‡  CHEST AND PRESENT â”‡ ")
        page2:Line()
...
wait(2)
    ...
    page2:Line()
        page2:Label("â”‡  EXPERTISE AND QUEST â”‡ ")
            page2:Line()
...
_G.concu = false
    ...
    page3:Line()
    page3:Label("â”‡ RAYLEIGH/DARK ATLAS CHECKING â”‡")
        page3:Line()
    ...
    page3:Line()
    page3:Label(" â”‡ USELESS ISLANDS LIKE YOU!!! â”‡")
        page3:Line()
    page3:Button(
        "Bald Island 1",
        function()
    ...
    page4:Line()
    page4:Label("â”‡ FREE FAKE WEAPON â”‡")
        page4:Line()
...
page4:Button("-â–º AFFINITIES GUI â—„-",function()
...
----------
page6:Line()
    page6:Label("â”‡ Spam Fruit Skill â”‡")
    page6:Line()
...
page6:Line()
    page6:Label("â”‡ Auto Skill Devil Fruit 1 â”‡")
    page6:Line()
    ...
    page6:Line()
    page6:Label("â”‡ Auto Skill Devil Fruit 2 â”‡")
    page6:Line()
